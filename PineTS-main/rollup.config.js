...
const BrowserConfigProd = {
    ...
    output: {
        ...
        sourcemap: true,
        footer:
            ';(function(){ var root = typeof window !== "undefined" ? window : (typeof globalThis !== "undefined" ? globalThis : this); if (root && root.PineTSLib) { root.PineTS = root.PineTSLib.PineTS; if (root.PineTS) { root.PineTS.Provider = root.PineTSLib.Provider; root.PineTS.Context = root.PineTSLib.Context; } } })();',
    },
    plugins: [
        excludeMockProvider(),
        resolve({
